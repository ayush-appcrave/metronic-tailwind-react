  ...
  return <div className="card max-w-[370px] w-full">
      <form className="card-body flex flex-col gap-5 p-10" noValidate onSubmit={formik.handleSubmit}>
        ...
        <div className="flex flex-col gap-1">
          ...
          {formik.touched.email && formik.errors.email && <span role="alert" className="text-red-500 text-xs mt-1">
              {formik.errors.email}
            </span>}
        </div>
        ...
        <div className="flex flex-col gap-1">
          ...
          {formik.touched.password && formik.errors.password && <span role="alert" className="text-red-500 text-xs mt-1">
        ...
        <div className="flex flex-col gap-1">
          ...
          {formik.touched.changepassword && formik.errors.changepassword && <span role="alert" className="text-red-500 text-xs mt-1">
        ...
        {formik.touched.acceptTerms && formik.errors.acceptTerms && <span role="alert" className="text-red-500 text-xs mt-1">
        ...
        {formik.status && <div className="text-red-500 text-xs mt-1" role="alert">
            {formik.status}
          </div>}
      </form>
    </div>;

...
const FirebaseLogin = () => {
  ...
  const formik = useFormik({
    ...
    onSubmit: async (values, {
      ...
      try {
        if (!login) {
          throw new Error('FirebareProveder is required for this form.');
        }
  ...
  return <>
      <form className="form w-100" onSubmit={formik.handleSubmit} noValidate id="kt_login_signin_form">
        ...
        <div className="fv-row mb-8">
          ...
          <input placeholder="Email" {...formik.getFieldProps('email')} className={clsx('form-control bg-transparent', {
        ...
        <div className="fv-row mb-3">
          ...
          <input type="password" autoComplete="off" {...formik.getFieldProps('password')} className={clsx('form-control bg-transparent', {

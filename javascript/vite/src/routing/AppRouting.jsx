...
import { CompanyProfilePage, GetStartedPage, SettingsSidebarPage, UserProfilePage } from '@/pages/account';
import { DashboardPage } from '@/pages/dashboard';
import { ActivityPage, BloggerPage, CampaignsCardPage, CampaignsListPage, Columns2Page, Columns3Page, CompanyPage, CreatorPage, CRMPage, DefaultPage, EmptyPage, FeedsPage, GamerPage, ModalPage, NetworkPage, NFTPage, PlainPage, TeamsPage, WorksPage } from '@/pages/public-profile';

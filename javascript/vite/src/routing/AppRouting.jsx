...
import { PublicProfileActivityPage, BloggerPage, CampaignsCardPage, CampaignsListPage, Columns2Page, Columns3Page, CompanyPage, CreatorPage, CRMPage, DefaultPage, EmptyPage, FeedsPage, GamerPage, ModalPage, NetworkPage, NFTPage, PlainPage, TeamsPage, WorksPage } from '@/pages/public-profile';
import { AccountActivityPages, AllowedIPAddressesPage, APIKeysPage, AppearancePage, BackupAndRecoveryPage, BasicPage, CompanyProfilePage, CurrentSessionsPage, DeviceManagementPage, EnterprisePage, GetStartedPage, HistoryPage, ImportMembersPage, IntegrationsPage, InviteAFriendPage, MembersStarterPage, NotificationsPage, OverviewPage, PermissionsCheckPage, PermissionsTogglePage, PlansPage, PrivacySettingsPage, RolesPage, SecurityGetStartedPage, SecurityLogPage, SettingsEnterprisePage, SettingsModalPage, SettingsPlainPage, SettingsSidebarPage, TeamInfoPage, TeamMembersPage, MembersTeamPage, TeamsStarterPage, UserProfilePage } from '@/pages/account';
import { AppRosterPage, MarketAuthorsPage, NetworkAuthorPage, NetworkGetStartedPage, NetworkMiniCardsPage, NetworkNFTPage, NetworkSocialPage, NetworkTeamCrewPage, SaasUsersPage, StoreClientsPage, TeamCrewPage, VisitorsPage } from '@/pages/network';
...
import { Example1 } from '@/pages/crud/Example1.jsx';
import { ScrollSpyExample } from '@/pages/scroll-spy/ScrollSpyExample.jsx';
const AppRouting = () => {
  const {

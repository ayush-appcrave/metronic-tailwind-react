          ...
          <div className="flex flex-col gap-2.5">
            ...
            <ImageInput value={images1} onChange={onChange1}>
              ...
              onImageRemove
                  ...
                  {fileList.map((image, index) => <div key={index}>
          ...
          <div className="flex flex-col gap-2.5">
            ...
            <ImageInput value={images3} onChange={onChange3}>
              ...
              dragProps
                  ...
                  <div className="btn btn-light justify-between h-auto py-3 lg:py-5 px-3 lg:px-6 group" onClick={fileList.length === 0 ? onImageUpload : () => {}} {...fileList.length === 0 ? dragProps : {}}>
                    {fileList.length === 0 ? 'Drag and drop your image here' : <div>

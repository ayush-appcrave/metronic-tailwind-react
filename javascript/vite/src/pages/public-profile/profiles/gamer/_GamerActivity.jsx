...
const GamerActivity = () => {
  return <div className="card">
      ...
      <div className="card-body">
        ...
        <ActivitiesLogin />
        <ActivitiesBloggingConference image="/media/illustrations/10.svg" heading="Email campaign sent to Jenny for a special promotion." datetime="1 week ago, 11:45 AM" title="First Campaign Created" />

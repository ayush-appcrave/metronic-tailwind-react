  ...
  return <div className="grid grid-cols-1 xl:grid-cols-3 gap-5 lg:gap-7.5">
      ...
      <div className="col-span-2">
        <div className="flex flex-col gap-5 lg:gap-7.5">
          <CreatorFeaturesHighlight image="/images/content/illustrations/restile.png" title="Restyle Your Space:<br>Soft Goods Makeover Ideas" description="Transform your living space beautifully with our Restyle Your Space: Soft Goods Makeover Ideas tutorial" more={{
          title: 'Get Started',
          url: '#'

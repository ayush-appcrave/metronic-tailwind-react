...
const SettingsModalPage = () => {
  const image = <img src={toAbsoluteUrl('/media/avatars/300-2.jpg')} className="rounded-full border-3 border-success max-h-[100px] max-w-full" />;
  return <>

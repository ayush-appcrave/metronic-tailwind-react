...
const SettingsSidebarAuthSingleSingOn = () => {
  ...
  const renderItem = (item, index) => {
    return <label className="flex align-stretch cursor-pointer bg-center h-44 bg-no-repeat border border-gray-300 rounded-xl border-dashed has-[:checked]:border-primary bg-[length:500px]" style={{
      backgroundImage: toAbsoluteUrl('/media/images/2600x1200/bg-5.png')
    }} key={index}>
        <div className="flex flex-col place-items-center place-content-center rounded-xl grow has-[:checked]:bg-[rgba(239,246,255,1)]">
          ...
          <input className="appearance-none" type="radio" name="sso_option" defaultChecked={index === 2} value="1" readOnly />
        </div>
      </label>;
  };
      ...
      <div className="card-body lg:pb-7.5">
        ...
        <div className="grid gap-5 lg:gap-7.5">
          ...
          <div className="flex items-center flex-wrap lg:flex-nowrap gap-2.5">
            ...
            <div className="grow">
              <input type="text" className="input w-full placeholder:text-gray-500" placeholder="02874374-367145773" value="" readOnly />
            </div>
          </div>
          ...
          <div className="flex items-center flex-wrap lg:flex-nowrap gap-2.5">
            ...
            <div className="grow">
              <input type="text" className="input w-full placeholder:text-gray-500" placeholder="23djfn784957f8022we2232307822-cey2442" value="" readOnly />
            </div>
          </div>
          ...
          <div className="flex items-center flex-wrap lg:flex-nowrap gap-2.5">
            ...
            <div className="grow">
              <div className="input-group">
                <input type="text" className="input w-full " placeholder="https://devs.keenthemes.com/rl/AirMikeStudios" value="" readOnly />

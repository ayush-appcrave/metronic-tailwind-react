...
const SettingsSidebarAuthSocialSignIn = () => {
  ...
  const renderBlock = (block, index) => {
    return <div key={index} className="flex items-center group border border-gray-200 cursor-pointer rounded-md gap-2.5 px-3.5 py-2.5">
        <a href="#" className="btn btn-light">
          <img src={toAbsoluteUrl(`/media/brand-logos/${block.logo}`)} className="size-5 shrink-0" alt="" />
          {block.title}
        </a>
      </div>;
  };

            ...
            <div className="relative size-[50px] shrink-0">
              <svg className="w-full h-full stroke-gray-300 fill-gray-100" width="44" height="48" viewBox="0 0 44 48" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <path d="M16.25 2.89711C19.8081 0.842838 24.1919 0.842837 27.75 2.89711L37.4006 8.46891C40.9587 10.5232 43.1506 14.3196 43.1506 
                  ...
                  39.5311C3.04125 37.4768 0.849365 33.6803 0.849365 29.5718V18.4282C0.849365 14.3196 3.04125 10.5232 6.59937 8.46891L16.25 2.89711Z" stroke="" strokeOpacity="0" />
              </svg>

              <div className="absolute leading-none left-2/4 top-2/4 -translate-y-2/4 -translate-x-2/4">
                {item.icon ? <KeenIcon icon="message-text-2" className="text-[1.35rem] ps-px text-gray-500" /> : <img src={toAbsoluteUrl('/media/brand-logos/slack.svg')} className="h-5" alt="" />}
              </div>
            </div>
          </div>

          <div className="flex flex-col">
            <a href="#" className="text-sm font-semibold text-gray-800 hover:text-primary-active mb-px">
              {item.title}
            </a>
  ...
  return <div className="card">
      ...
      <div className="card-body lg:py-7.5">
        ...
        <div className="flex flex-col gap-3.5 mb-7">
          ...
          <label className="flex items-center gap-1.5">
            <input type="radio" className="radio radio-sm" name="radio-1" defaultChecked value="2" readOnly />

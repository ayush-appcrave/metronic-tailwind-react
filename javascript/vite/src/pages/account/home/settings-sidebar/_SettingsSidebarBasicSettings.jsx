  ...
  return <div className="card pb-2.5">
      ...
      <div className="card-body grid gap-5">
        <div className="flex items-center flex-wrap lg:flex-nowrap gap-2.5">
          <span className="text-2sm font-medium text-gray-700 max-w-56 w-full">Photo</span>
          <div className="flex items-center justify-between flex-wrap grow gap-2.5">
            ...
            <div className="image-input size-16 mt-1.5" data-image-input="true">
              ...
              <div data-image-input-remove data-tooltip="true" data-tooltip-trigger="hover" className="btn btn-icon btn-light shadow-default absolute size-5 z-1 -top-0.5 -right-0.5 rounded-full">
                <KeenIcon icon="cross" className="!text-md" />

                <span className="tooltip">Click to remove or revert</span>
              </div>

              <div className="image-input-placeholder rounded-full border-2 border-success image-input-empty:border-gray-300" style={{
              backgroundImage: toAbsoluteUrl('/media/avatars/blank.png')
            }}>
                <div className="image-input-preview rounded-full" style={{
        ...
        <div className="flex items-center flex-wrap lg:flex-nowrap gap-2.5">
          <span className="text-2sm font-medium text-gray-700 max-w-56 w-full">Phone number</span>
          <div className="grow min-w-48">
            <input type="text" className="input w-full placeholder:text-gray-500" placeholder="Phone number" value="" readOnly />
          </div>
        </div>

        <div className="flex items-center flex-wrap lg:flex-nowrap gap-2.5">
          <span className="text-2sm font-medium text-gray-700 max-w-56 w-full">Visibility</span>
          <div className="grow min-w-48">
        ...
        <div className="flex items-center flex-wrap lg:flex-nowrap gap-2.5 mb-2.5">
          <span className="text-2sm font-medium text-gray-700 max-w-56 w-full">Avaibality</span>
          <div className="grow min-w-48">

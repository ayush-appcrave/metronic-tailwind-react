  ...
  const renderItem = (each, index) => {
    return <tr key={index}>
        <td className="text-center">
          <input data-datatable-row-check="true" type="checkbox" className="checkbox checkbox-sm" value={index + 1} readOnly />
        </td>
        ...
        <td>
          <div className="flex items-center gap-2.5">
            ...
            <div className="flex flex-col gap-0.5">
              <Link to="/network/user-cards/mini-cards" className="leading-none font-medium text-sm text-gray-900 hover:text-primary">
                {each.member.name}
              </Link>
        ...
        <td>
          <div className="flex items-center gap-1.5">
            <img src={toAbsoluteUrl(`/media/flags/${each.location.flag}`)} className="h-4 rounded-full" alt="flag" />
      ...
      <div className="card-header py-5 flex-wrap">
        ...
        <div className="flex gap-6">
          <div className="relative">
            ...
            <input type="text" className="input input-sm pl-8" placeholder="Search Members" readOnly />
          </div>
              ...
              <thead>
                <tr>
                  <th className="w-[60px] text-center">
                    <input type="checkbox" className="checkbox checkbox-sm" data-datatable-check="true" readOnly />
                  </th>

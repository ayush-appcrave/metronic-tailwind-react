...
const DataGrid = (props) => {
	...
	const defaultValues = {
		...
		cellsBorder: true,
		loadingText: 'Loading...',
		// Default value for loadingText
		rowSelect: false,
		// Default value for rowSelect
		emptyState: 'No data available',
		// Default value for emptyInfo
		paginationInfo: '{from} - {to} of {count}',
		// Default value for paginationInfo
		...
		// Default limit for "load more"
		paginationMore: false,
		// Default for paginationMore
	...
	const { pagination: initialPagination, sorting: initialSorting } =
		loadSavedState();

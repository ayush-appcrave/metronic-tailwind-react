...
const DataGridPagination = () => {
  ...
  const paginationInfo = props.paginationInfo ? props.paginationInfo.replace('{from}', from.toString()).replace('{to}', to.toString()).replace('{count}', count.toString()) : `${from} - ${to} of ${count}`; // Default fallback format

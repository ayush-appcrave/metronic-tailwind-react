...
function ViewUser(props) {
  ...
  return <>
      {!loading ? <Box>
          ...
          {currentUser.avatar && <Avatar alt={currentUser.first_name} src={toAbsoluteUrl(currentUser.avatar)} />}
          <Typography>
        ...
        fontSize: '1rem'
          ...
          <Skeleton variant="text" width={'5%'} sx={{
        fontSize: '1rem'
      }} />
          <Skeleton variant="circular" width={40} height={40} />
          <Skeleton variant="text" width={'50%'} sx={{
        fontSize: '1rem'
      }} />
          <Skeleton variant="text" width={'15%'} sx={{
        fontSize: '1rem'
      }} />
          <Skeleton variant="text" width={'60%'} sx={{
        fontSize: '1rem'
      }} />
          <Skeleton variant="text" width={'55%'} sx={{
        fontSize: '1rem'
      }} />
        </Box>}

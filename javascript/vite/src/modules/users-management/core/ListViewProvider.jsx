...
import { calculatedGroupingIsDisabled, calculateIsAllDataSelected, groupingOnSelect, groupingOnSelectAll, initialListView } from '../helpers';
...
const ListViewProvider = ({
  ...
  return <ListViewContext.Provider value={{
    selected,
    itemIdForUpdate,
    setItemIdForUpdate,
    disabled,

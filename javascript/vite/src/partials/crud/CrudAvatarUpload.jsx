...
const CrudAvatarUpload = ({
  ...
  return <div className="image-input size-16" data-image-input="true">
      <input type="file" name="avatar" accept=".png, .jpg, .jpeg" />
      <input type="hidden" name="avatar_remove" />

      <div data-image-input-remove data-tooltip="#image_input_tooltip" data-tooltip-trigger="hover" className="btn btn-icon btn-icon-xs btn-light shadow-default absolute z-1 size-5 -top-0.5 -right-0.5 rounded-full">
        <KeenIcon icon="cross" />
      </div>
      ...
      backgroundImage: `url(${toAbsoluteUrl(`/media/avatars/blank.png`)})`
        ...
        {image ? <div className="image-input-preview rounded-full"></div> : <div className="image-input-preview rounded-full" style={{
        backgroundImage: `url(${toAbsoluteUrl(`/media/avatars/300-2.png`)})`
      }}></div>}

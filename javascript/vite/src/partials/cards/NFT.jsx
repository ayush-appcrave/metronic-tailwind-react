...
const NFT = ({
  ...
  return <div className="card border-0 mb-5">
      <img src={toAbsoluteUrl(`/images/content/stock/${image}`)} className="rounded-t-xl max-w-[270px] shrink-0" alt="" />

      <div className="card-border card-rounded-b px-3.5 h-full pt-5 pb-3.5">
        <div className="pb-6">
          <a href="#" className="font-semibold block text-gray-800 hover:text-primary text-md leading-4 mb-2">
            {title}
          </a>

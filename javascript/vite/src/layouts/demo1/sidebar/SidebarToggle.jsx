...
const SidebarToggle = () => {
  ...
  const lightToggle = () => {
    return <button className={clsx('btn btn-icon btn-icon-md size-[30px] rounded-lg border border-gray-200 dark:border-gray-300 bg-light text-gray-500 hover:text-gray-700 group absolute start-full top-2/4 -translate-x-2/4 -translate-y-2/4', layout.options.sidebar.collapse && 'active')} onClick={handleClick} aria-label="Toggle sidebar">

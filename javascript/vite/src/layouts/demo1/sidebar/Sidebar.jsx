...
const Sidebar = () => {
  ...
  const renderContent = () => {
    return <div className="sidebar lg:fixed lg:z-20 lg:top-0 lg:bottom-0 lg:left-0 lg:translate-x-0 lg:flex flex-col items-stretch shrink-0 bg-white lg:border lg:border-r-gray-200">
  ...
  if (desktopMode) {
    ...
    return <Drawer open={mobileSidebarOpen} onClose={handleMobileSidebarClose} PaperProps={{
      sx: {

...
interface TableBodySubCRUDCustomProps {
  dense: boolean;
}

function TableBodySubCRUDCustom(props: TableBodySubCRUDCustomProps) {
  ...
  return (
    ...
    >
      {data.map((row, index) => {
        ...
        return (
          <UserManagementSubCRUDTableRow key={labelId} row={row}></UserManagementSubCRUDTableRow>
        );
      })}

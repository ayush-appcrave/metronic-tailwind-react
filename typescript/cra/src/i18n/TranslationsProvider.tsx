...
import { DEFAULT_LANGUAGE, I18N_CONFIG_KEY } from "./consts";
import { Language, TranslationsProviderProps } from "./types";
...
const initialProps: TranslationsProviderProps = {
...
const TranslationsContext =
  createContext<TranslationsProviderProps>(initialProps);
...
export { TranslationsProvider, useLang };

...
const NavItemComponent = forwardRef<HTMLDivElement | null, NavItemType>(
  function NavItemComponent(props, ref) {
        ...
        sx={{
          ...
          paddingLeft:
            depth === 1
              ...
              : styles.SUB_ITEM_PADDING_X *
                (parentVariant === 'inline' ? styles.INDENTION * depth : 1),
    ...
    const renderContent = (
      ...
      >
        ...
        {!minimize &&
          hasChildren &&
          (variant === 'dropdown' ? renderItemDropdown() : renderItemSub)}
      </Box>
    );

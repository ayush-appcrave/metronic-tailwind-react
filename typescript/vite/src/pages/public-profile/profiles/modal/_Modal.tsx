...
const Modal = () => {
  return (
    <>
      ...
      <div
        className="modal modal-open:!flex py-[5%]"
        data-modal="true"
              ...
              <div className="grid lg:grid-cols-3 gap-3 w-full items-center">                
                <div className="flex items-center flex-col">
                  <div className="flex items-center gap-1.5 mb-2">
                    <a href="#" className="text-lg leading-5 font-semibold text-gray-800 hover:text-primary">Jenny Klabbe</a>
                    <svg
                ...
                <div className="flex justify-end gap-2">
                  <button className="dropdown-toggle btn btn-sm btn-primary"><KeenIcon icon="users" /> Connect</button>
                  <button className="btn btn-sm btn-icon btn-light"><KeenIcon icon="messages" /></button>
                  <div
                    className="dropdown"
                    data-dropdown="true"
                  ...
                  >
                    <button className="dropdown-toggle btn btn-sm btn-icon btn-light"><KeenIcon icon="dots-vertical" /></button>

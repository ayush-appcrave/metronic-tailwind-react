      ...
      <div className="card rounded-xl">
        <div className="flex items-center justify-between grow gap-5 p-5 bg-[center_right_-8rem] bg-no-repeat bg-[length:700px] upgrade-bg">
          <div className="flex items-center gap-4">
            ...
            <div className="flex flex-col gap-2">
              <div className="flex items-center gap-2.5">
                ...
                <span className="badge badge-sm badge-danger badge-outline">Trial expires in 29 days</span>
              </div>

              <div className="text-2sm text-gray-700">
                Enterprise Components.io is a website offering high-quality, advanced UI components designed for developers, enhancing <br />
          ...
          <div className="flex items-center gap-1.5 shrink-0">
            <a href="#" className="btn btn-sm btn-light btn-clear">Cancel Trial</a>
            <a href="#" className="btn btn-sm btn-dark">Upgrade Now</a>
          </div>
        </div>
      </div>
    </>

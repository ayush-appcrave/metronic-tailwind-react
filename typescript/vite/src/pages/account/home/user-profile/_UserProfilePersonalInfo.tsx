        ...
        <table className="table align-middle text-sm text-gray-500">
          <tbody>
              ...
              <td className="py-2 text-center min-w-16">
                <div className="image-input size-16 mt-1.5" data-image-input="true">
                  ...
                  <div
                    ...
                    className="btn btn-icon btn-icon-md btn-light shadow-default absolute size-5 z-1 -top-0.5 -right-0.5 rounded-full"
                  >
                    <KeenIcon icon="cross" />
            ...
            <tr>
              ...
              <td className="py-2 text-gray-700">Jason Tatum</td>
            ...
            <tr>
              ...
              <td className="py-3 text-gray-700">28 May 1996</td>
              <td className="py-3 text-center">
                <a
                  href="#"
                  className="btn btn-sm btn-icon btn-icon-lg text-primary hover:text-primary-active"
            ...
            <tr>
              ...
              <td className="py-3 text-gray-700">Male</td>
              <td className="py-3 text-center">
                <a
                  href="#"
                  className="btn btn-sm btn-icon btn-icon-lg text-primary hover:text-primary-active"

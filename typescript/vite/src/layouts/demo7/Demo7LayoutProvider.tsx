...
// Initial layout provider properties, using Demo7 layout configuration as the default
...
// Provider component that sets up the layout state and context for Demo7 layout
const Demo7LayoutProvider = ({ children }: PropsWithChildren) => {
  ...
  // Merge the Demo7 layout configuration with the current layout configuration fetched via getLayout

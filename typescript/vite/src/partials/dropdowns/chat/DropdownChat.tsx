        ...
        <div className="flex items-center justify-between flex-wrap gap-2 px-5">
          <div className="flex items-center flex-wrap gap-2">
            ...
            <div className="flex flex-col">
              <Link to="#" className="text-2sm font-semibold text-gray-900 hover:text-primary-active">HR Team</Link>
        ...
        <div className="flex items-center justify-between gap-3 grow">
          <div className="flex flex-col">
            <div className="flex gap-1 text-2sm mb-px">
              <Link to="#" className="hover:text-primary-active font-semibold text-gray-900">Jane Perez</Link>
          ...
          <div className="flex gap-2.5">
            <button className="btn btn-light btn-xs" data-dismiss="#join_request">Decline</button>

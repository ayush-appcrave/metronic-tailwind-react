...
import { Avatar, Avatars } from '../common';
import { IConnectionItem, IConnectionProps } from './interfaces';
...
const Connection = ({
  ...
  const renderItem = (statistic: IConnectionItem) => {
    return (
      <>
        <div className="grid grid-cols-1 gap-1.5 border border-dashed border-gray-300 rounded-md px-2.5 py-2 shrink-0  min-w-24 max-w-auto">
